...
public class GetAPITest {
    ...
    public void Color_Lover_Patterns_API_endpoint_exists(String URL, String testCaseName) {
    ...
    public void I_should_see_the_Number_of_Views_of_Pattern(String patternNum, String expectedNum) throws Throwable{
